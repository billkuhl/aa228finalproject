...
# ╔═╡ 220becce-09c7-4d70-8b02-0e2fabae60ec
using POMDPs

# ╔═╡ 9c3dc050-de75-4352-bc7f-b517990269e5
using POMDPModels

# ╔═╡ 863684d6-d1cc-4a0e-a06d-efcc296b5982
using MCTS

# ╔═╡ d3d835c5-6d76-4355-8c68-9c2a4e2afcd1
using StaticArrays

# ╔═╡ 09cd78f1-4fbb-4974-aad3-081c4862ddd1
using Markdown

# ╔═╡ d304d788-988f-4517-8ef3-9b0c11343db4
using InteractiveUtils

# ╔═╡ 92f90af2-bfa4-4fcd-bd86-36e8c46d9a5e
using Plots

# ╔═╡ 7e5e89cd-643d-450a-9014-b24934e2b8f3
using Random

# ╔═╡ 680122a1-cea1-4bd4-afec-90a68acbacb6
using Distributions

# ╔═╡ 5ced43df-14e0-4f32-8b18-68f3767f63aa
using SatelliteToolbox

# ╔═╡ 3bc3deb6-38ce-44f1-93ee-e51e1289aec3
using LinearAlgebra

# ╔═╡ d3e7fdd5-f1d6-49ab-b484-5762a0b7c0ca
include("transition.jl")

# ╔═╡ a7532325-1d3e-4c35-8a64-6c9017cb0336
include("structure.jl")

# ╔═╡ df96a890-474e-433d-85cf-7eb2193d68a4
include("reward.jl")

# ╔═╡ 5150ee68-c16e-44fd-bc51-fb3dbc230183
import QuickPOMDPs: QuickPOMDP, QuickMDP

# ╔═╡ 4297e5f4-4736-40c6-8663-788741da1716
import POMDPTools: ImplicitDistribution, Deterministic, stepthrough

# ╔═╡ ac1cdc09-3ced-4ffd-b597-1b4f53372802
...
# ╔═╡ 98e650ed-0cce-4f80-9056-d34d0af0f872
begin
	...
	for (s,a,r) in stepthrough(satellite,policy,"s,a,r", max_steps=10)
	    append!(states,[s])
	    append!(actions,[a])
		append!(rewards,[r])
	end
...
# ╔═╡ 435f2028-ac9b-4b0b-b722-d2520fefb53c
...
# ╔═╡ e43f74c8-c231-4dd3-9178-40f71201b804
length(unique(target_x))

# ╔═╡ 3d7610db-b0dc-481a-a051-8225c86b66bd
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "0b66441f3ad98139487f71a60d57bafd0d0f74b0"
...
# ╠═74fd9d42-005a-4619-ae0a-ec9e47e6b8a3
# ╠═0349e3a8-e118-46f9-bf54-8cc485824ac3
# ╠═0951b142-fd57-420d-a5a2-173d9e4d2a26
# ╠═efc14573-5b4d-48dc-86a5-7851486797c2
# ╠═fe808700-b1f6-4be8-9854-3d8c5c7d0ec5
# ╠═98e650ed-0cce-4f80-9056-d34d0af0f872
# ╠═435f2028-ac9b-4b0b-b722-d2520fefb53c
# ╠═e43f74c8-c231-4dd3-9178-40f71201b804
