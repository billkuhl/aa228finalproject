...
# ╔═╡ 9935884d-1ba1-4b9e-bfe9-c50341ea8526
using POMDPs

# ╔═╡ ad8d32d8-79fb-4dcf-91af-114c95da2cb2
using POMDPModels

# ╔═╡ 68ed4a6e-d0ba-4556-a28e-0ccc9c17269c
using POMDPTools

# ╔═╡ 734147fd-148a-4cf0-bc6f-5a10e96c34ef
using MCTS

# ╔═╡ dc408825-3726-46e7-ae63-ded03a3336b7
using StaticArrays

# ╔═╡ 3f3cd1fd-aba9-45a7-95fb-afdfbf8d4329
using Markdown

# ╔═╡ 8fc1b725-e3da-4ace-b1df-7fdad7dd5c7f
using InteractiveUtils

# ╔═╡ aa711d4d-f909-449f-b175-fe55909c196b
using Plots

# ╔═╡ 9369a651-d88b-4e43-bd9e-5231a72ae562
using Random

# ╔═╡ 86cada78-7161-4ac6-98d3-8e9728829526
using Distributions

# ╔═╡ 3e0c71cb-ea7f-480d-91d1-91d116777136
using SatelliteToolbox

# ╔═╡ ff168973-b43e-422c-90dc-74d8f6a46176
using LinearAlgebra

# ╔═╡ b23a9fce-e8d3-42cd-b377-17ead00da547
using D3Trees

# ╔═╡ 4235bd9d-9f0b-4480-8163-af4df9a71c36
using ProgressBars

# ╔═╡ dcaa006a-d6e7-4a59-8f7c-bd6ebe16eb13
include("transition.jl")

# ╔═╡ 527a821f-8d10-4d8a-ab71-beb89ae6d048
include("structure.jl")

# ╔═╡ a1c7ccd6-7fd9-426a-90bf-6059cdfb3735
include("reward.jl")

# ╔═╡ dfbf00a4-48ce-4e33-8014-e62e77c7b3f8
import QuickPOMDPs: QuickPOMDP, QuickMDP

# ╔═╡ e8f6270b-4abe-49f9-a18d-000d53f85654
...
# ╔═╡ d4168311-fc32-46c1-9c5a-89a50ad74f52
states = []

# ╔═╡ 5b7b2a66-c210-43a2-9ec8-3767cd058168
rewards = []

# ╔═╡ e992aa2b-eb1c-41a6-8181-7c25535c643b
actions = []

# ╔═╡ fc007587-a75e-4b6b-b2aa-9fab2198beec
for (s,a,r) in ProgressBar(stepthrough(satellite,policy,"s,a,r", max_steps=1))
    append!(states,[s])
	append!(actions,[a])
	append!(rewards,[r])
end

# ╔═╡ aedc9582-b0c2-4c24-86b9-e200c6d6bb02
intruder_x = []

# ╔═╡ 31929f49-1835-4027-860e-3bf7a11015ac
target_x = []

# ╔═╡ 4c6ada71-b538-4aca-8f6d-99fa8707ff56
for s in states
...
# ╔═╡ cd7a6317-625e-4ad0-a9a7-83df115f06a1
println("Printing Sat Position Data")

# ╔═╡ a452c2a7-fc02-4db5-a656-8c45aeab39b9
println(target_x)

# ╔═╡ 03311951-df32-4e23-86f9-402ff7e8bc84
println("Print Intruder Position Data")

# ╔═╡ f558f840-c659-49a4-b72a-454c6ca14ffa
println(intruder_x)

# ╔═╡ eaf718b1-70d9-4462-944c-a18fc6965bf6
println("4. Visualize Search Tree")

# ╔═╡ 4ab87eb4-9d29-48ef-95d0-cf466b7fea1d
println(a)

# ╔═╡ 19a5e7a2-d7a3-42ea-bd2b-a27c6b19ffb4
tree = info[:tree]

# ╔═╡ ab7a71df-49cb-4023-88ff-258f0beb32d3
inchrome(D3Tree(tree))

# ╔═╡ 1acc14c6-fd73-4fcc-bb50-62d5001e3662
...
# ╔═╡ 2fcb0dbc-5953-4c36-93bd-651fd30a1d0a
a,info = action_info(policy,initial_state)

# ╔═╡ 56ab4259-dd17-4777-95b7-cdba8c399ac1
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "7cf9c6061adefea5c461a5dcd6a247c5f54e066e"
...
[[deps.POMDPModels]]
deps = ["ColorSchemes", "Compose", "Distributions", "POMDPTools", "POMDPs", "Printf", "Random", "StaticArrays", "StatsBase"]
git-tree-sha1 = "5f2a0adf8a4e4f9de89e31f2c583b40b088ad201"
...
deps = ["Dates", "Reexport", "SatelliteToolboxAtmosphericModels", "SatelliteToolboxBase", "SatelliteToolboxCelestialBodies", "SatelliteToolboxGeomagneticField", "SatelliteToolboxGravityModels", "SatelliteToolboxPropagators", "SatelliteToolboxSgp4", "SatelliteToolboxTle", "SatelliteToolboxTransformations"]
git-tree-sha1 = "ff31f30cdff20266c3e7dd4786fa9eaa5ca2ca36"
...
[[deps.SatelliteToolboxPropagators]]
deps = ["Crayons", "Dates", "LinearAlgebra", "PrecompileTools", "Printf", "Reexport", "SatelliteToolboxBase", "SatelliteToolboxSgp4", "SatelliteToolboxTle", "StaticArrays"]
git-tree-sha1 = "c45953b08d316432ddc168bc15df0a3a2f76518e"
...
git-tree-sha1 = "0bf1d32269942154d6289ac664e0e1b528eaf664"
uuid = "7ff27aeb-5fff-4337-a9ee-a9fe6b7ed35e"
version = "1.0.4"
...
git-tree-sha1 = "d7a0dec17056114802a00badb6142786b0767da5"
