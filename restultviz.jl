...
# ╔═╡ c7180083-6dc5-4df4-98fc-c934b18bc0dc
using Plots

# ╔═╡ 65505959-ac9e-4b96-886f-ffbe66f87f40
using LinearAlgebra

# ╔═╡ 003068e6-6e9a-4544-b7f0-ca34ed7a03fe
using JSON

# ╔═╡ 3455ede4-0f02-4396-aae1-d6f47fed9099
rawdata = JSON.parsefile("data\\2d_1k_5ki.json")

# ╔═╡ 4dafa282-0fdf-4aa1-be9b-91722cff0f17
data = JSON.parse(rawdata)

# ╔═╡ 0cfe9194-68ec-43ec-b65a-6e63dd4daad8
data["intruder"]
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "949f131a05d36539106594bcc71d75e2e4438008"
